...
trueValues = {"$f$": 0.67, #proportion of events which are signal
              "$c_0$": 0.5, "$c_1$": 8, "$c_2$": 0.5, #parameters for double exponential time background
              "$k_m$": 2, #decay constant for combinatorial mass background
              "$m_{B^0_s}$": 5.36691, r"$\sigma_m$": 0.01, #signal mass mean and width
              '$x$': 26.93, '$y$': 0.124, '$gamma$': 0.7,
            ...
            # 'effSS': 1, 'effOS': 1, 'wSS': 0.5, 'wOS': 0.5
              'effSS': 0.42, 'effOS': 0.8, 'wSS': 0.42, 'wOS': 0.39
              }
